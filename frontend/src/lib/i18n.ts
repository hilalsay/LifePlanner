...
const en: Dict = {
  ...
  "habits.deleteBody": "Delete \"{name}\"? This also removes its tracked history and can't be undone.",
  ...
  "tracking.addBookPlaceholder": "Search or add a book...",
  "tracking.noBooksYet": "No books in your reading list yet.",
  "tracking.bookStatus": "Status",
  "tracking.bookTitle": "Title",
  "tracking.bookAuthor": "Author",
  "tracking.bookAuthorPlaceholder": "e.g. James Clear",
  "tracking.bookGenre": "Genre",
  "tracking.bookGenrePlaceholder": "e.g. Self-help",
  "tracking.bookStartDate": "Date started",
  "tracking.bookEndDate": "Date finished",
  "tracking.bookCurrentPage": "Current page",
  "tracking.bookTotalPages": "Total pages",
  "tracking.myReview": "My Review",
  "tracking.completedPrompt": "You finished this book! Rate it and share your thoughts below.",
  "tracking.bookRating": "Rating",
  "tracking.bookReviewText": "Written review",
  "tracking.bookReviewPlaceholder": "What did you think? Would you recommend it?",
  "tracking.myNotes": "My Notes",
  "tracking.myNotesPlaceholder": "Highlights, quotes, key takeaways...",
  "tracking.confirmDelete": "Tap again to confirm",
  "tracking.editBook": "Edit book",
  ...
  "settings.feature1": "AI weekly reviews (Ollama / Gemini)",
  "settings.feature2": "Natural language task parsing (Gemini)",
  "settings.feature3": "AI motivational messages (Ollama / Gemini)",
...
const tr: Dict = {
  ...
  // Habit tracker
  "habits.trackerTitle": "Alışkanlık Takibi",
  ...
  "habits.prevWeek": "Önceki hafta",
  "habits.nextWeek": "Sonraki hafta",
  "habits.options": "Seçenekler",
  "habits.edit": "Düzenle",
  "habits.delete": "Sil",
  "habits.editTitle": "Alışkanlığı düzenle",
  "habits.name": "Ad",
  "habits.description": "Açıklama",
  "habits.frequency": "Sıklık",
  "habits.daily": "Günlük",
  "habits.weekly": "Haftalık",
  "habits.target": "Hedef",
  "habits.color": "Renk",
  "habits.save": "Kaydet",
  "habits.cancel": "İptal",
  "habits.deleteTitle": "Alışkanlık silinsin mi?",
  "habits.deleteBody": "\"{name}\" silinsin mi? Bu, takip geçmişini de kaldırır ve geri alınamaz.",
  ...
  "tracking.addBookPlaceholder": "Kitap ara veya ekle...",
  "tracking.noBooksYet": "Okuma listenizde henüz kitap yok.",
  "tracking.bookStatus": "Durum",
  "tracking.bookTitle": "Başlık",
  "tracking.bookAuthor": "Yazar",
  "tracking.bookAuthorPlaceholder": "örn. James Clear",
  "tracking.bookGenre": "Tür",
  "tracking.bookGenrePlaceholder": "örn. Kişisel gelişim",
  "tracking.bookStartDate": "Başlangıç tarihi",
  "tracking.bookEndDate": "Bitiş tarihi",
  "tracking.bookCurrentPage": "Mevcut sayfa",
  "tracking.bookTotalPages": "Toplam sayfa",
  "tracking.myReview": "Değerlendirmem",
  "tracking.completedPrompt": "Bu kitabı bitirdiniz! Aşağıdan puanını ver ve düşüncelerini paylaş.",
  "tracking.bookRating": "Puan",
  "tracking.bookReviewText": "Yazılı değerlendirme",
  "tracking.bookReviewPlaceholder": "Ne düşünüyorsun? Önerir misin?",
  "tracking.myNotes": "Notlarım",
  "tracking.myNotesPlaceholder": "Öne çıkanlar, alıntılar, önemli çıkarımlar...",
  "tracking.confirmDelete": "Onaylamak için tekrar dokun",
  "tracking.editBook": "Kitabı düzenle",
  ...
  "settings.feature1": "Yapay zekâ haftalık değerlendirmeler (Ollama / Gemini)",
  "settings.feature2": "Doğal dil görev ayrıştırma (Gemini)",
  "settings.feature3": "Yapay zekâ motivasyon mesajları (Ollama / Gemini)",
